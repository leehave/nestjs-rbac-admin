...
// ── 供应商 ─────────────────────────────────────────────
export const queryProviderPage = (params: { page?: number; limit?: number; name?: string }) =>
  request<API.AiProviderPageResult>('/api/ai/admin/providers/list', {
    method: 'GET',
    params,
  });

export const addProvider = (data: Record<string, any>) =>
...
export const queryProviderOptions = () =>
  request<API.AiProviderOptionsResult>('/api/ai/admin/providers/options', { method: 'GET' });

// ── 模型 ───────────────────────────────────────────────
export const queryModelPage = (params: { page?: number; limit?: number; name?: string }) =>
  request<API.AiModelPageResult>('/api/ai/admin/models/list', {
    method: 'GET',
    params,
  });

export const addModel = (data: Record<string, any>) =>
...
// ── 会话 ───────────────────────────────────────────────
export const querySessionList = (params: { page?: number; limit?: number }) =>
  request<API.AiSessionListResult>('/api/ai/sessions', { method: 'GET', params });

export const addSession = (data: { model_id?: string; title?: string }) =>
  request<API.AiSessionCreateResult>('/api/ai/sessions', { method: 'POST', data });

export const queryMessageList = (uuid: string) =>
