...
import { DataPermissionModule } from './module/system/data-permission/data-permission.module';
...
import { DataScopeInterceptor } from './common/interceptor/data-scope.interceptor';
