...
@Injectable()
export class MindDocumentIndexQueueService implements OnModuleInit, OnModuleDestroy {
  private readonly logger = new Logger(MindDocumentIndexQueueService.name);
  private stop = false;
  ...
  constructor(
    ...
    private readonly processor: MindDocumentIndexProcessorService,
  ...
  private requireLoginForWorker() {
    return this.configService.get<boolean>('mind.documents.indexRequireLogin') === true;
  }
